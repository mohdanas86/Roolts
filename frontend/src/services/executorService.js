...
export const executorService = {
    ...
    /**
     * Start an interactive execution session via Socket.IO
     */
    executeInteractive: (code, language) => {
        socketService.emit('exec:start', { code, language });
    },
     ...
     */
    sendInput: (data) => {
        socketService.emit('exec:input', { data });
    },
