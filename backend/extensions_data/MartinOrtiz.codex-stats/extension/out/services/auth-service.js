...
/**
 * Service responsible for authentication and auth data management
 */
class AuthService {
    constructor() {
    ...
    /**
     * Load authentication data from the Codex auth file
     */
    async loadAuthData() {
        ...
        try {
            ...
            const idTokenPayload = this.parseJWT(authJson.tokens.id_token);
            return {
